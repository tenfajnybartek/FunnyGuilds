...
public class MessageConfiguration extends OkaeriConfig implements MessageRepository {
    ...
    public SendableMessage helpList = ChatHolder.message(
            "&8&m------------------&8[ &6&lSYSTEM GILDII &8]&8&m------------------",
            " &8• &c/g zaloz <tag> [nazwa] &8- &7Tworzy gildie",
            " &8• &c/g zapros [gracz] &8- &7Zaprasza gracza do gildii",
            " &8• &c/g dolacz <tag> &8- &7Przyjmuje zaproszenie do gildii",
            " &8• &c/g info <tag> &8- &7Informacje o danej gildii",
            " &8• &c/g dom &8- &7Teleportuje do bazy gildii",
            " &8• &c/g powieksz &8- &7Powieksza teren gildii",
            " &8• &c/g przedluz &8- &7Przedluza waznosc gildii",
            " &8• &c/g lider [gracz] &8- &7Oddaje zalozyciela gildii",
            " &8• &c/g zastepca [gracz] &8- &7Nadaje zastepce gildii",
            " &8• &c/g panel &8- &7Panel lidera do zarządzania gildią",
            " &8• &c/g sojusz <tag> &8- &7Pozwala nawiazac sojusz",
            " &8• &c/g opusc &8- &7Opuszcza gildie",
            " &8• &c/g wyrzuc [gracz] &8- &7Wyrzuca gracza z gildii",
            " &8• &c/g rozwiaz <tag> &8- &7Rozwiazuje sojusz",
            " &8• &c/g usun &8- &7Usuwa gildie",
            " &8• &c/g pvp &8- &7Ustawia pvp między członkami gildii",
            " &8• &c/g itemy &8- &7Pokazuje przedmioty potrzebne do zalozenia gildii",
            " &8• &c/g ucieczka &8- &7Rozpoczyna ucieczke z terenu innej gildii",
            " &8• &c/g rankreset &8- &7Resetuje ranking do stanu pierwotnego",
            "&8&m------------------&8[ &6&lSYSTEM GILDII &8]&8&m------------------"
    );
