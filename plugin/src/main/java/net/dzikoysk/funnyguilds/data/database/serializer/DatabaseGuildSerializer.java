...
public final class DatabaseGuildSerializer {
    ...
    public static Option<Guild> deserialize(ResultSet resultSet) {
        ...
        try {
            ...
            Instant protection = TimeUtils.positiveOrNullInstant(resultSet.getLong("protection")); // Changed from "attacked" in 5.0
    ...
    public static void serialize(Guild guild) {
        ...
        statement.set("protection", guild.getProtection().toEpochMilli()); // Changed from "attacked" in 5.0
